...
public interface IBusiness {
	...
	public Task CreatePdfFile(PdfFileReadDto pdfFileReadDto, IFormFile file, CancellationToken cancellationToken = default);
	public Task<string?> GetPdfFileById(int id, CancellationToken cancellationToken = default);
	...
	public Task<PdfFile> UpdatePdfFile(int fileId, IFormFile newFile, CancellationToken cancellationToken = default);
