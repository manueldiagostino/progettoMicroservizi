...
namespace AuthorsHandler.Repository.Abstraction
{
	public interface IRepository
	{
		...
		public Task<int?> UpdateExternalLinkForAuthor(string name, string surname, string url, CancellationToken ct = default);
		public Task<ExternalLink?> RemoveExternalLinkForAuthor(string name, string surname, string url, CancellationToken ct = default);
